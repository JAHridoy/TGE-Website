...
const CanadaPage = () => {
  const benefits = [
    {
      icon: "work_history",
      title: "Co-op Excellence",
      desc: "Gain industry-leading paid work experience through integrated co-op programs at top universities.",
    ...
    },
    {
      ...
      desc: "Ranked as one of the world's most welcoming and safe multicultural societies for international scholars.",
    ...
    },
    {
      ...
      title: "PGWP Pathway",
      desc: "Stay and work for up to 3 years after graduation with clear pathways to permanent residency (PR).",
  ...
  const quickStats = [
    { label: "Capital", value: "Ottawa", icon: "location_city" },
    { label: "Currency", value: "Dollar (CAD)", icon: "payments" },
    { label: "Intake", value: "Sept / Jan / May", icon: "calendar_month" },
  ...
  const financialData = [
    { category: "Undergraduate Tuition", range: "CAD $15k – $35k", period: "Per Academic Year", icon: "school" },
    { category: "Postgraduate Tuition", range: "CAD $18k – $40k", period: "Per Academic Year", icon: "workspace_premium" },
    { category: "Living Expenses", range: "CAD $1,500 – $2,000", period: "Monthly Average", icon: "home" },
    { category: "GIC Requirement", range: "CAD $20,635", period: "Single Applicant (2024)", icon: "account_balance_wallet" },
  ];

  const admissionRequirements = [
    { title: "Academic Credentials", list: ["HSC with minimum 60% for Bachelors (SDS)", "4-year Bachelors with 3.0+ CGPA for Masters", "Official WES evaluation (if requested by university)"] },
    { title: "Essential Documents", list: ["Valid Passport (at least 2 years validity)", "Compelling Study Plan / SOP", "GIC Certificate (Proof of Funds for SDS)"] },
    { title: "Language Proficiency", list: ["IELTS Academic (6.5 overall, 6.0 each for SDS)", "PTE Academic (60+) accepted for SDS", "TOEFL iBT (83+) also widely accepted"] },
  ];

  const faqs = [
    { q: "What is the Student Direct Stream (SDS)?", a: "SDS is an expedited study permit processing program for students from certain countries, including Bangladesh. It requires upfront payment of tuition and a GIC." },
    { q: "How long is the Post-Graduation Work Permit (PGWP)?", a: "For programs of 2 years or more, you are eligible for a 3-year PGWP. For programs between 8 months and 2 years, the permit duration matches the program length." },
    { q: "Can I work off-campus in Canada?", a: "Yes, international students with a valid study permit can work up to 20 hours per week off-campus during academic sessions and full-time during breaks." },
    { q: "Is health insurance included in tuition?", a: "Most universities have mandatory health insurance plans for international students, but coverage details and costs vary by province (e.g., OHIP in Ontario vs MSP in BC)." }
  ];
        ...
        <section className="px-12 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center overflow-hidden mb-20">
          <div className="space-y-6 text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-primary tracking-tight leading-[1.15]">
              Inclusive Education and a <span className="text-secondary">Lifetime of Opportunity</span>
            </h1>
            <p className="text-sm text-on-surface-variant max-w-lg leading-relaxed">
              Unlock your future in Canada with high-quality academics, multicultural welcoming environments, and clear paths to permanent residency.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              <Link 
                to="/consultation?country=Canada"
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-8 bg-surface-container-lowest p-5 rounded-2xl shadow-xl hidden lg:block border border-gray-50">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-bold text-primary">PGWP Eligibility</span>
              </div>
              <p className="text-xs text-on-surface-variant leading-relaxed">Most public institutions allow for up to 3 years of work rights after graduation.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-surface-container-low py-20 px-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight mb-4">Why Students Choose Canada</h2>
              <p className="text-on-surface-variant text-sm">Consistent excellence, inclusive culture, and strong career support define the Canadian academic journey.</p>
            </div>
        ...
        <section className="py-20 px-12 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-primary tracking-tight">World-Class Canadian Universities</h2>
            </div>
        ...
        <section className="py-24 px-4 md:px-12 max-w-6xl mx-auto space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-4xl font-bold text-primary tracking-tight mb-6">Sustainable Academic Investment</h2>
              <p className="text-on-surface-variant text-sm leading-relaxed mb-8">
                Canada offers a competitive cost-of-education versus quality ratio. With the new 2024 GIC requirements, students are better prepared for the real cost of living in urban hubs.
              </p>
              <div className="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <p className="text-xs font-bold text-primary uppercase">GIC Preparation</p>
                </div>
                <p className="text-xs text-on-surface-variant leading-relaxed">
                  The Guaranteed Investment Certificate (GIC) of $20,635 ensures you have sufficient funds for your first year, released to you in monthly installments.
                </p>
              </div>
            </div>
          ...
          <div className="bg-surface-container-low rounded-[32px] px-2 py-10 md:p-20 relative overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
              <div>
                ...
                <h2 className="text-4xl font-bold text-primary tracking-tight mb-8">SDS Expedited Architecture</h2>
              ...
              <div className="space-y-10">
                <div className="bg-primary text-primary-foreground p-6 md:p-10 rounded-2xl shadow-xl">
                  ...
                  <p className="text-sm leading-relaxed mb-6 opacity-80 italic">
                    "Canada isn't just a destination to study; it's a destination to build a life. The PGWP is the strongest post-study work permit globally."
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-secondary text-sm pt-1">check_circle</span>
                      <p className="text-xs leading-relaxed"><strong className="text-white">Post-Grad Work:</strong> Up to 3 years of work eligibility in any sector across Canada.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-secondary text-sm pt-1">check_circle</span>
                      <p className="text-xs leading-relaxed"><strong className="text-white">PR Pathways:</strong> Express Entry, PNP, and CEC streams value Canadian education and work experience.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-secondary text-sm pt-1">check_circle</span>
                      <p className="text-xs leading-relaxed"><strong className="text-white">Tech Innovation:</strong> Major hubs like Toronto and Vancouver offer high-growth tech and engineering opportunities.</p>
                    </div>
                  </div>
                </div>
                <div className="bg-cta-orange/5 p-6 md:p-8 rounded-2xl border border-cta-orange/20">
                  ...
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    Always aim for **SDS (Student Direct Stream)** if possible. It has a significantly higher success rate and faster processing (20 calendar days) compared to the non-SDS route.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-center text-secondary font-bold text-xs uppercase tracking-widest mb-4">Canada Expertise</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-lg mb-10 max-w-xl mx-auto leading-relaxed">
                Join thousands of scholars who discovered their global academic pathway in the Great White North.
              </p>
              <Link
                to="/consultation?country=Canada"
